...
- walk-in option in restaurant reservation display page (instead of showing contact info for reso)

- ****validations for models (new forms, error msgs, flash notifications)
- ********HTML markup, CSS Styling**************

Walk-in tracking feature for restaurant

Sort, Search, Reviews w/ ratings

Owner edit/delete

Reservations edit/delete
...
- reservations look at restaurant capacity
